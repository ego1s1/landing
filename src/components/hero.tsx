    ...
    >
      ...
      <div className="bg-[#24283b] border-b border-[#414868] px-3.5 py-2 flex items-center justify-between gap-2 text-xs select-none">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {isMinimized && (
            <span className="text-[10px] text-[#e0af68] bg-[#1a1b26] border border-[#3b4261] px-1.5 py-0.2 rounded-none">
              [MINIMIZED]
            </span>
          )}
        </div>
        <div className="flex items-center gap-2">
          {isMinimized ? (
            ...
            <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-none bg-[#1a1b26] border border-[#3b4261] text-[11px] text-[#9ece6a]">
      ...
      {!isMinimized && (
        <div className="p-5 md:p-6 space-y-5">
          {/* Clean & Legible Hero Header */}
          <div className="flex flex-wrap items-center justify-between gap-6 pb-2 border-b border-[#3b4261]/50">
            <div className="flex items-center gap-4">
              <div className="relative size-20 md:size-22 shrink-0 overflow-hidden rounded-[4px] border border-[#414868] bg-[#1a1b26] shadow-[2px_2px_0px_#101014]">
                <Image
                  src="/avatar.jpeg"
              ...
              <div className="flex flex-col justify-center gap-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-[#7dcfff] font-bold text-lg">❯</span>
                  <h1 className="text-2xl font-extrabold text-[#c0caf5] tracking-tight">
                    Priyanshu Sharma
                  </h1>
                </div>
                <div className="text-xs font-bold text-[#7dcfff] bg-[#1a1b26] border border-[#3b4261] px-2.5 py-1 rounded-[2px] w-fit">
                  UPCOMING EMBEDDED SOFTWARE INTERN @ HONEYWELL AEROSPACE
                </div>
                <div className="flex flex-wrap items-center gap-2 text-[11px] text-[#565f89] mt-0.5">
                  <span className="px-1.5 py-0.5 bg-[#1a1b26] border border-[#3b4261] text-[#e0af68]">
                    [ECE @ MIT MANIPAL &apos;27]
                  </span>
                  <span className="px-1.5 py-0.5 bg-[#1a1b26] border border-[#3b4261] text-[#bb9af7]">
                    [IEEE HACKSAGON &apos;25 WINNER]
                  </span>
                </div>
              </div>
            </div>
          ...
          {/* Neofetch Element with ASCII Rabbit Mascot */}
          <div className="bg-[#1a1b26] border border-[#3b4261] rounded-[4px] p-4 text-xs font-mono grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
            {/* ASCII Rabbit Mascot */}
            <div className="sm:col-span-5 flex flex-col items-center justify-center text-[#bb9af7] font-bold leading-none select-none py-3 bg-[#1f2335]/60 border border-[#3b4261]/50 rounded-[3px]">
              <pre className="text-[12px] md:text-sm text-[#7dcfff] leading-tight font-mono">
{`   (\\_/)
  ( •.• )
 (>  < )
  /   \\
 (_____)`}
              ...
              <span className="text-[11px] text-[#565f89] mt-2.5 tracking-wider font-bold">ego1s1@macos</span>
            </div>

            {/* Neofetch System Fields */}
            <div className="sm:col-span-7 space-y-1.5 text-[#a9b1d6]">
              ...
              <div className="flex gap-2">
                ...
                <span className="text-[#9ece6a] font-semibold">Upcoming Embedded Intern @ Honeywell Aerospace</span>
              </div>
              <div className="flex gap-2">
                <span className="text-[#bb9af7] w-20 shrink-0 font-bold">PREV:</span>
                <span className="text-[#c0caf5]">IT Intern @ Kotak Life | SWE Intern @ Awkward Studio</span>
              </div>
              <div className="flex gap-2">
          ...
          <div className="bg-[#24283b] border border-[#3b4261] px-3.5 py-1.5 flex items-center justify-between text-[11px] text-[#565f89] rounded-[2px]">
            <div className="flex items-center gap-3">
              <span className="bg-[#7aa2f7] text-[#1a1b26] px-1.5 py-0.2 font-bold rounded-none">
                NORMAL
              </span>
