...
export interface ThemeColors {
  ...
  textDim: string;
  accent: string;       // blue
  accentCyan: string;   // cyan / teal
  accentPurple: string; // purple / mauve
  accentGreen: string;  // green
  accentYellow: string; // yellow / peach
  accentRed: string;    // red
  dotGrid: string;      // dot grid overlay color
